...
export default function MessageBubble({ message, showAvatar = true, showDate = false }: Props) {
            ...
            <div>
              {editing ? (
                ...
                <div style={{
                  ...
                  border: isAI ? '1px solid rgba(99,102,241,0.2)'
                    : isSelf ? 'none'
                    : '1px solid rgba(255,255,255,0.07)',
                  boxShadow: isSelf ? '0 2px 12px rgba(99,102,241,0.25)' : 'none',
                  maxWidth: '100%',
                }}>
